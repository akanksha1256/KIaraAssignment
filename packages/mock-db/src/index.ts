...
const leases: Lease[] = [
  {
    ...
    monthlyRent: 1800,
    terms:
      "12-month lease. No pets. Utilities included. $500 security deposit.",
  },
  {
    id: "lease-2",
    unitId: "unit-2",
  ...
  // unit-3 (Apt 103) is vacant — no lease
  {
    ...
    monthlyRent: 2500,
    terms:
      "12-month lease. No smoking. Parking included. $800 security deposit.",
  },
  {
    id: "lease-4",
    unitId: "unit-5",
    ...
    monthlyRent: 2800,
    terms:
      "12-month lease. Pets allowed. Rooftop access included. $900 security deposit.",
  },
  {
    id: "lease-5",
    unitId: "unit-6",
    ...
    monthlyRent: 3200,
    terms:
      "12-month lease. No subletting. Gym access included. $1,000 security deposit.",
  },
