...
const tenants: Tenant[] = [
  ...
  },
  {
    id: "tenant-12",
    name: "Leo Carter",
    contact: "+1 512-555-0112",
    email: "leo@example.com",
    kyc_status: "verified",
    kyc_verified_on: "2026-02-10T00:00:00.000Z",
    kyc_document: "/documents/kyc-sample.pdf",
  },
  {
    id: "tenant-13",
    name: "Maya Singh",
    contact: "+1 512-555-0113",
    email: "maya@example.com",
    kyc_status: "verified",
    kyc_verified_on: "2026-03-05T00:00:00.000Z",
    kyc_document: "/documents/kyc-sample.pdf",
  },
  {
    id: "tenant-14",
    name: "Nina Osei",
    contact: "+1 512-555-0114",
    email: "nina@example.com",
    kyc_status: "verified",
    kyc_verified_on: "2026-01-20T00:00:00.000Z",
    kyc_document: "/documents/kyc-sample.pdf",
  },
  {
    id: "tenant-15",
    name: "Omar Hassan",
    contact: "+1 512-555-0115",
    email: "omar@example.com",
    kyc_status: "verified",
    kyc_verified_on: "2026-02-14T00:00:00.000Z",
    kyc_document: "/documents/kyc-sample.pdf",
  },
  {
    id: "tenant-16",
    name: "Priya Nair",
    contact: "+1 512-555-0116",
    email: "priya@example.com",
    kyc_status: "verified",
    kyc_verified_on: "2026-03-18T00:00:00.000Z",
    kyc_document: "/documents/kyc-sample.pdf",
  },
];
...
const leases: Lease[] = [
  ...
  },
  {
    ...
    end_date: "2027-02-28T00:00:00.000Z",
    monthly_rent: 1900,
    terms: "12-month lease. No pets. $550 security deposit.",
    lease_document: "/documents/lease-sample.pdf",
  },
  {
    id: "lease-3",
  ...
  // The Grand — Studio A & B occupied, Studio C & D vacant
  {
    ...
    end_date: "2027-02-28T00:00:00.000Z",
    monthly_rent: 2600,
    terms: "12-month lease. No pets. Gym access included. $800 security deposit.",
    lease_document: "/documents/lease-sample.pdf",
  },
  {
    id: "lease-13",
    ...
    end_date: "2027-03-31T00:00:00.000Z",
    monthly_rent: 2900,
    terms: "12-month lease. Pets allowed. Rooftop access included. $950 security deposit.",
    lease_document: "/documents/lease-sample.pdf",
  },
];
...
const payments: Payment[] = [
  ...
  // Leo – lease-12 (The Grand, Studio A) — May overdue, June outstanding
  {
    ...
    amount_paid: 2600,
    status: "paid",
    paid_date: "2026-03-14T00:00:00.000Z",
    method: "Bank Transfer",
    last_reminded_on: null,
  },
  {
    ...
    amount_paid: 2600,
    status: "paid",
    paid_date: "2026-04-12T00:00:00.000Z",
    method: "Bank Transfer",
    last_reminded_on: null,
  },
  {
  ...
  // Maya – lease-13 (The Grand, Studio B) — May overdue, June outstanding
  {
    ...
    amount_paid: 2900,
    status: "paid",
    paid_date: "2026-04-16T00:00:00.000Z",
    method: "Credit Card",
    last_reminded_on: null,
  },
  {
  ...
  // Nina – lease-15 (Riverside Lofts, Loft D) — May overdue, June outstanding
  {
    ...
    amount_paid: 2300,
    status: "paid",
    paid_date: "2026-02-13T00:00:00.000Z",
    method: "Credit Card",
    last_reminded_on: null,
  },
  {
    ...
    amount_paid: 2300,
    status: "paid",
    paid_date: "2026-03-12T00:00:00.000Z",
    method: "Credit Card",
    last_reminded_on: null,
  },
  {
    ...
    amount_paid: 2300,
    status: "paid",
    paid_date: "2026-04-11T00:00:00.000Z",
    method: "Credit Card",
    last_reminded_on: null,
  },
  {
  ...
  // Omar – lease-14 (Maple Heights, Apt 103) — May overdue, June outstanding
  {
    ...
    amount_paid: 1900,
    status: "paid",
    paid_date: "2026-03-13T00:00:00.000Z",
    method: "Bank Transfer",
    last_reminded_on: null,
  },
  {
    ...
    amount_paid: 1900,
    status: "paid",
    paid_date: "2026-04-14T00:00:00.000Z",
    method: "Bank Transfer",
    last_reminded_on: null,
  },
  {
